# 💬 Hưng-SieuNhan — Ứng dụng Chat Realtime
...
|:---:|:---:|
| ![Chat dark mode](screenshots/01-chat-darkmode.png) | ![Emoji](screenshots/03-emoji-picker.png) |

### Nhóm & Kết bạn
| Xem thành viên nhóm | Tìm & kết bạn |
|:---:|:---:|
| ![Group members](screenshots/02-group-members.png) | ![Add friend](screenshots/04-add-friend.png) |
